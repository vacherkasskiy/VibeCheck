...
using ReviewService.Gateway.Api.DTOs.Reviews.CreateCompanyReview;
using ReviewService.Gateway.Api.DTOs.Reviews.DeleteCompanyReview;
using ReviewService.Gateway.Api.DTOs.Reviews.GetCompanyReviews;
using ReviewService.Gateway.Api.DTOs.Reviews.GetUserReviews;
using Swashbuckle.AspNetCore.Annotations;

namespace ReviewService.Gateway.Api.Controllers;
